...
AI-powered study companion for competitive exam preparation.
...
- **Pomodoro Timer** - Focus mode with fullscreen
- **Schedule** - Calendar-based planning
- **Reports** - Track hours, completion, progress
- **Analytics** - Visualize study patterns

### 👥 Social
- **Friends** - Connect with students
