...
**AI Study Assistant**
Groq-powered (Llama) study support for personalized recommendations, task suggestions, and motivational guidance based on your exam goals and progress.
...
React 18, TypeScript, Node.js, Express, MongoDB, Vercel, Groq (Llama) API, Passport.js, Resend Email
