            ...
            <tr>
              <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                  ...
                  <tr>
                    <td style="padding: 0 40px 20px;">
                      <h2 style="margin: 0; color: #1f2937; font-size: 24px; font-weight: 600;">Welcome Aboard! 🎉</h2>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding: 0 40px 30px;">
                      <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.5;">
                        Hi ${name},<br><br>
                        Welcome to StudyBuddy! We're excited to have you join our community of dedicated learners.
                      </p>
                      <div style="background-color: #f0f9ff; border-left: 4px solid #6366f1; padding: 16px; margin: 20px 0;">
                        <p style="margin: 0; color: #1e40af; font-size: 14px; line-height: 1.5;">
                          <strong>Get Started:</strong><br>
                          • Set your exam goals and target date<br>
                          • Create your study schedule<br>
                          • Connect with study buddies<br>
                          • Track your progress with AI insights
                        </p>
                      </div>
                      <div style="text-align: center; margin: 30px 0;">
                        <a href="${process.env.CLIENT_URL}" style="display: inline-block; background-color: #6366f1; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-size: 16px; font-weight: 600;">
                          Start Studying
                        </a>
                      </div>
                    </td>
