...
export class UsernameTrie {
   ...
   */
  insert(username: string, userId: string, userData: any): void {
   ...
   */
  searchByPrefix(prefix: string, maxResults: number = 20): any[] {
   ...
   */
  private collectUsers(node: TrieNode, results: any[], maxResults: number): void {
  ...
  private removeHelper(node: TrieNode, username: string, index: number): boolean {
...
// Singleton instance
export const usernameTrie = new UsernameTrie();
