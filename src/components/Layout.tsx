  ...
  return (
    <UnifiedPageWrapper>
      <div className="min-h-screen flex flex-col md:flex-row">
        {/* Mobile Header */}
        <header className="md:hidden h-14 border-b flex items-center justify-between px-4 bg-background/60 backdrop-blur-xl sticky top-0 z-40 supports-[backdrop-filter]:bg-background/60">
        ...
        >
          ...
          <div className="p-3 border-t">
            <Button
              ...
              className="w-full justify-start gap-2 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] hover:bg-destructive/10 hover:text-destructive"
            >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Desktop Header */}
          <header className="hidden md:flex h-14 border-b items-center justify-between px-4 lg:px-6 bg-background/60 backdrop-blur-xl sticky top-0 z-30 supports-[backdrop-filter]:bg-background/60">
            <div className="flex items-center gap-2">
              {studying && (
