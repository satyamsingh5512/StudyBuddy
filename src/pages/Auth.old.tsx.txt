    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 p-4">
      <div className="w-full max-w-6xl">
        <motion.div
          ...
          className="grid lg:grid-cols-2 gap-0 bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden"
        >
          {/* Left Side - Branding */}
            ...
            <div className="relative z-10 space-y-8">
              ...
              >
                {[
                  ...
                  { icon: BookOpen, text: 'Track progress with detailed analytics' },
