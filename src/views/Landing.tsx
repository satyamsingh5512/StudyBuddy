...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    const canUseShader = window.matchMedia(
              ...
              <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
                    StudyBuddy keeps the full loop in view, from availability and time blocks to
                    focused sessions and a report of what actually happened.
                  </p>
                  <Link
                  ...
                  {[
                    {
                      ...
                      step: '01',
                      title: 'Plan',
                      text: 'Share your available time and priorities.',
                    },
                    {
                      icon: Clock3,
                      step: '02',
                      title: 'Focus',
                      text: 'Move through clear, timed study blocks.',
                    },
                    {
                      icon: BarChart3,
                      step: '03',
                      title: 'Review',
                      text: 'Use progress signals to adjust tomorrow.',
                    },
                  ].map((item) => (
            ...
            <div className="flex items-center justify-center px-4 sm:px-6">
              ...
              >
                ...
                <p className="max-w-xl mx-auto text-lg text-zinc-700 dark:text-zinc-300 sm:text-xl">
                  Start with your exam goal and availability. StudyBuddy handles the next practical
                  step.
                </p>
                <Link
                  to={user ? '/schedule' : '/auth'}
            ...
            <footer className="glass-panel border-x-0 border-b-0 py-8 text-sm text-zinc-600 dark:text-zinc-400">
              <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 text-center sm:px-6 md:flex-row md:text-left">
                ...
                <div className="flex flex-wrap justify-center gap-x-5 gap-y-2 font-bold sm:gap-6">
                  <a
                    href="/terms"
                    className="hover:text-black dark:hover:text-white hover:underline transition-all"
                  >
                    Terms
                  </a>
                  <a
