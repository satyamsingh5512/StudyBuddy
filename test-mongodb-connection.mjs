...
async function testConnection() {
  ...
  try {
    ...
    if (error.message.includes('authentication failed')) {
      ...
      console.error('   1. The MongoDB Atlas cluster may have SSL/TLS configuration issues');
      console.error('   2. Try creating a NEW MongoDB Atlas cluster (M0 free tier)');
      console.error('   3. Or install MongoDB locally and use: mongodb://localhost:27017/studybuddy');
